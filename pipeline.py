...
LUA_SHA1 = get_hash(os.path.join(CWD, 'scratch.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'p':
                wget_args.extend(['--warc-header', 'scratch-project: '+item_value])
                wget_args.append('https://projects.scratch.mit.edu/'+item_value)
            elif item_type == 'a':
                wget_args.extend(['--warc-header', 'scratch-asset: '+item_value])
                wget_args.append('https://assets.scratch.mit.edu/internalapi/asset/'+item_value+'/get/')
            else:
...
project = Project(
    title='Scratch',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/thumb/4/4f/Scratch_Logo.png/800px-Scratch_Logo.png" height="50px" title=""/>
        <h2>scratch.mit.edu <span class="links"><a href="https://scratch.mit.edu/">Website</a> &middot; <a href="http://tracker.archiveteam.org/scratch/">Leaderboard</a></span></h2>
        <p>Archiving Scratch projects.</p>
    '''
)
